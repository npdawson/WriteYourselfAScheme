...
/* package WriteYourselfAScheme-0.1.0.0 */
#define VERSION_WriteYourselfAScheme "0.1.0.0"
#define MIN_VERSION_WriteYourselfAScheme(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "WriteYourselfAScheme-0.1.0.0-9XCnyXZ9nZK8zfaQQc7IOM"

#define CURRENT_PACKAGE_KEY "WriteYourselfAScheme-0.1.0.0-9XCnyXZ9nZK8zfaQQc7IOM"
